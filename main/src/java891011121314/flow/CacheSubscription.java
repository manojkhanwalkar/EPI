...
public class CacheSubscription implements Flow.Subscription {
    ...
    public CacheSubscription(Flow.Subscriber<? super Context> subscriber, Flow.Publisher<Context> publisher) {
